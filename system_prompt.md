...
3. Only state facts from the retrieved context or fact overrides. Never invent anything. If a relevant specific detail is not available, explicitly acknowledge the gap and suggest following up for more information.
